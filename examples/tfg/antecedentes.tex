...
término genérico (que debe usarse cuando en los demás casos) es «cuadro». Si las
columnas están bien alineadas, las líneas verticales estorban más que ayudan (no
las pongas). Los cuadros se referencian de este modo (ver
Cuadro~\ref{tab:rpc-semantics}).
...
\texcmd{lstset} en tu \texttt{main.tex}. El código LaTeX del listado
